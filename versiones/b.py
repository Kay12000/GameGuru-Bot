...
def get_response(question, msg, user_id):
    ...
    if gpt4o_mini_answer:
        ...
        write_db(db_data)
        # También guardar la respuesta en training_data.json
        data.append((question, gpt4o_mini_answer))
        save_training_data()
        return gpt4o_mini_answer + " (La respuesta se ha guardado correctamente)"
    ...
    save_training_data()
    return advanced_response + " (Respuesta generada por el modelo avanzado)"
