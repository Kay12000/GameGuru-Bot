...
stop_words = set(stopwords.words('spanish'))
important_words = {"cómo", "qué", "por qué", "cuál", "cuándo", "dónde", "quién", "qué", "cómo", "hola", "adiós", "gracias", "bien", "mal", "sí", "no", "ok", "okay", "vale", "de acuerdo", "entendido", "claro", "correcto", "incorrecto", "bueno", "genial", "excelente", "perfecto", "mejor", "peor", "favor", "favorito", "favorita", "favoritos", "favoritas", "mejor", "mejores", "peor",
"peores", "más", "menos", "mayor", "menor", "mayores", "menores", "mayoría", "minoría", "mayoritario", "minoritario", "mayoritariamente", "minoritariamente", "mayoritarios", "minoritarios", "mayoritarias", "minoritarias"}
